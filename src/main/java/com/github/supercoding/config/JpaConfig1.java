...
@EnableJpaRepositories(
		basePackages = {"com.github.supercoding.respository.electoricstore.items", "com.github.supercoding.respository.electoricstore.storeSales"},
...
public class JpaConfig1 {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean1(@Qualifier("dataSource1") DataSource dataSource){
		...
		em.setPackagesToScan("com.github.supercoding.respository.electoricstore.items", "com.github.supercoding.respository.electoricstore.storeSales");
