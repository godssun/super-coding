...
class AirReservationServiceUnitTest {
	...
	void FindUserFavoritePlaceTicketsCase1() {
		...
		List<AirlineTicketEntity> airlineTickets = Arrays.asList(
				AirlineTicketEntity.builder()
						.ticketId(1)
	...
	void FindUserFavoritePlaceTicketsCase2() {
		...
		List<AirlineTicketEntity> airlineTickets = Arrays.asList(
				AirlineTicketEntity.builder().ticketId(1).arrivalLocation(likePlace).ticketType(ticketType).build(),
				AirlineTicketEntity.builder().ticketId(2).arrivalLocation(likePlace).ticketType(ticketType).build(),
				AirlineTicketEntity.builder().ticketId(3).arrivalLocation(likePlace).ticketType(ticketType).build(),
				AirlineTicketEntity.builder().ticketId(4).arrivalLocation(likePlace).ticketType(ticketType).build()
		);
	...
	void FindUserFavoritePlaceTicketsCase3() {
		...
		List<AirlineTicketEntity> airlineTickets = new ArrayList<>();
